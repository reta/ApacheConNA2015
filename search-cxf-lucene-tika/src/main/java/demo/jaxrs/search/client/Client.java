...
public final class Client {
    ...
    public static void main(String args[]) throws Exception {               
        ...
        uploadToCatalog(url, httpClient, "about-this-demo.docx");
        
        list(url, httpClient);        
        
        search(url, httpClient, "ct eq 'java'");
        search(url, httpClient, "ct eq 'websockets'");
        
        search(url, httpClient, "ct eq 'Java'");        
        search(url, httpClient, "ct eq 'WebSockets'");
        
        search(url, httpClient, "ct eq 'jaxrs' or source eq '*jaxrs*'");
        search(url, httpClient, "ct eq 'tika'");
    ...
    private static void search(final String url, final HttpClient httpClient, final String expression) 
        ...
        get.setQueryString("$filter=" + URLEncoder.encode(expression, "UTF-8"));
